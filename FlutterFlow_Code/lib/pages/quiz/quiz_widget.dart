...
class _QuizWidgetState extends State<QuizWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.tempQuestions = await QuizQuestionsTable().queryRows(
        queryFn: (q) => q,
      );
      _model.selectedQuestion = await actions.getRandomQuestion(
        _model.tempQuestions!.toList(),
        3,
      );
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuariosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRow> quizUsuariosRowList = snapshot.data!;
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text(
                                                              'Completado'),
                                                          content: Text(
                                                              'Se  ha enviando un SMS de confirmacion'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
